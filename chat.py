...
LABELS = {
    'plan': '生成交易方案', 'scan': '扫描全市场', 'news': '新闻风险',
...
def run_chat(text, symbol=None):
    ...
    try:
        ...
        lines.append(f'⚠️ 拿不到行情：`{type(e).__name__}`')
